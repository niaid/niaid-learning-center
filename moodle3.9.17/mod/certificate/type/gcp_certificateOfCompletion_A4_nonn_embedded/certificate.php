...
certificate_print_text($pdf, $x, $y + 43, 'C', 'Helvetica', '', 26, fullname($USER));
...
certificate_print_text($pdf, $x+6, $y + 95, 'C', 'Helvetica', '', 16, certificate_get_date($certificate, $certrecord, $course));
...
//    $pdf->SetTextColor(120, 0, 0);
 //   certificate_print_text($pdf, $x, $y + 102, 'C', 'Times', '', 20, 'CMRP IS AN ACCREDITED PROVIDER OF IACET® CEUs');
  ...
  //  $pdf->SetTextColor(0, 0, 0);
//}
//certificate_print_text($pdf, $x + 140, $y + 70, 'C', 'Helvetica', '', 11, certificate_get_date($certificate, $certrecord, $course));
//certificate_print_text($pdf, $x + 15 , $y + 146, 'L', 'Helvetica', '', 11, 'Barbara van der Schalie, Clinical Training Manager');
